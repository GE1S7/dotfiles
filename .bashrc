...
export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/usr/local/go/bin:/usr/local/go/bin:/home/kacper/go/bin:/opt/purevpn-cli/bin

export PATH=$PATH:/home/kacper/.spicetify
export PATH=$PATH:/home/kacper/BashScript
export PATH=$PATH:/home/kacper/go/bin
export PATH=$PATH:/snap/racket/current/usr/bin
...
duck () {
    ...
    command lynx "https://duckduckgo.com/lite?q=$url"
}
...
google () {
    declare url=$(urlencode "$*")
    command lynx "https://google.com/search?q=$url"
}
...
# start tmux with the terminal session
